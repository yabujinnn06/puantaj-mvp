...
REM =========================
REM PuantajMVP Quick Test (v4)
REM - Calls a separate PowerShell runner script
REM =========================
...
set "RUNNER=%~dp0puantaj_test_runner.ps1"

if not exist "%RUNNER%" (
  echo [ERR] Runner bulunamadi: "%RUNNER%"
  echo Bu dosya BAT ile ayni klasorde olmali: puantaj_test_runner.ps1
  pause
  exit /b 2
)
