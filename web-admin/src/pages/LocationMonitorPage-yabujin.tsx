...
import { LocationMonitorMap } from '../components/location-monitor/LocationMonitorMap-yabujin'
...
const LazyLocationMonitor3DView = lazy(async () => {
  const module = await import('../components/location-monitor/LocationMonitor3DView-yabujin')
