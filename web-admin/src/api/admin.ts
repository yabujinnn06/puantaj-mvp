...
export async function getAdminUserClaimDetail(
  adminUserId: number,
): Promise<AdminUserClaimDetail> {
...
export async function getRegions(params?: {
  ...
  const response = await apiClient.get<Region[]>("/api/admin/regions", {
    params,
  });
  return response.data;
}
...
export async function updateRegion(
  ...
  const response = await apiClient.patch<Region>(
...
export async function getAdminUserMfaStatus(
  adminUserId: number,
): Promise<AdminUserMfaStatus> {
  const response = await apiClient.get<AdminUserMfaStatus>(
    `/api/admin/admin-users/${adminUserId}/mfa`,
  );
  return response.data;
}

export async function startAdminUserMfaSetup(
  adminUserId: number,
): Promise<AdminUserMfaSetupStartResponse> {
...
export async function resetAdminUserMfa(
  ...
  const response = await apiClient.post<{ ok: boolean }>(
    `/api/admin/admin-users/${adminUserId}/mfa/reset`,
    payload,
  );
  return response.data;
}
...
export async function getDepartmentsFiltered(params?: {
  region_id?: number;
}): Promise<Department[]> {
  const response = await apiClient.get<Department[]>("/admin/departments", {
    params,
...
export async function getEmployeeDetail(
  ...
  const response = await apiClient.get<EmployeeDetail>(
    `/api/admin/employees/${employeeId}/detail`,
  );
  return response.data;
}
...
export async function updateEmployeeActive(
  ...
  const response = await apiClient.patch<Employee>(
    `/api/admin/employees/${employeeId}/active`,
    payload,
  );
  return response.data;
}
...
export async function updateEmployeeShift(
  ...
  const response = await apiClient.patch<Employee>(
    `/api/admin/employees/${employeeId}/shift`,
    payload,
  );
  return response.data;
}
...
export async function updateEmployeeRegion(
  ...
  const response = await apiClient.patch<Employee>(
    `/api/admin/employees/${employeeId}/region`,
    payload,
  );
  return response.data;
}
...
export async function getEmployeeLocation(
  ...
  const response = await apiClient.get<EmployeeLocation>(
    `/admin/employee-locations/${employeeId}`,
  );
  return response.data;
}
...
export async function upsertEmployeeLocation(
  ...
  const response = await apiClient.put<EmployeeLocation>(
    `/admin/employee-locations/${employeeId}`,
    payload,
  );
  return response.data;
...
export async function getDepartmentWeeklyRules(params?: {
  department_id?: number;
}): Promise<DepartmentWeeklyRule[]> {
  const response = await apiClient.get<DepartmentWeeklyRule[]>(
...
export async function getDepartmentShifts(params?: {
  ...
  const response = await apiClient.get<DepartmentShift[]>(
...
export async function upsertDepartmentShift(
  payload: UpsertDepartmentShiftPayload,
): Promise<DepartmentShift> {
  const response = await apiClient.post<DepartmentShift>(
    "/admin/department-shifts",
    payload,
  );
  return response.data;
...
export async function deleteDepartmentShift(
  shiftId: number,
): Promise<{ ok: boolean; id: number }> {
  const response = await apiClient.delete<{ ok: boolean; id: number }>(
    `/admin/department-shifts/${shiftId}`,
  );
  return response.data;
}
...
export async function getQrCodes(
  ...
  const response = await apiClient.get<QrCode[]>("/api/admin/qr/codes", {
    params,
  });
  return response.data;
}
...
export async function updateQrCode(
  ...
  const response = await apiClient.patch<QrCode>(
    `/api/admin/qr/codes/${codeId}`,
    payload,
  );
  return response.data;
}
...
export async function assignQrCodePoints(
  ...
  const response = await apiClient.post<QrCode>(
    `/api/admin/qr/codes/${codeId}/points`,
    payload,
  );
  return response.data;
}

export async function unassignQrCodePoint(
  codeId: number,
  pointId: number,
): Promise<{ ok: boolean; id: number }> {
  const response = await apiClient.delete<{ ok: boolean; id: number }>(
...
export async function getQrPoints(
  params: GetQrPointsParams = {},
): Promise<QrPoint[]> {
  const response = await apiClient.get<QrPoint[]>("/api/admin/qr/points", {
    params,
  });
  return response.data;
}
...
export async function createQrPoint(
  payload: CreateQrPointPayload,
): Promise<QrPoint> {
  const response = await apiClient.post<QrPoint>(
    "/api/admin/qr/points",
    payload,
  );
  return response.data;
...
export async function updateQrPoint(
  pointId: number,
  payload: UpdateQrPointPayload,
): Promise<QrPoint> {
  const response = await apiClient.patch<QrPoint>(
    `/api/admin/qr/points/${pointId}`,
    payload,
  );
  return response.data;
}

export async function deactivateQrPoint(
  pointId: number,
): Promise<{ ok: boolean; id: number }> {
  const response = await apiClient.delete<{ ok: boolean; id: number }>(
    `/api/admin/qr/points/${pointId}`,
...
export async function upsertSchedulePlan(
  payload: UpsertSchedulePlanPayload,
): Promise<SchedulePlan> {
  const response = await apiClient.post<SchedulePlan>(
...
export async function getSchedulePlans(
  ...
  const response = await apiClient.get<SchedulePlan[]>(
    "/api/admin/schedule-plans",
    { params },
  );
  return response.data;
...
export async function cancelSchedulePlan(
  planId: number,
): Promise<{ ok: boolean; id: number }> {
  const response = await apiClient.delete<{ ok: boolean; id: number }>(
    `/api/admin/schedule-plans/${planId}`,
  );
  return response.data;
}

export async function getAttendanceEvents(
  params: AttendanceEventParams = {},
): Promise<AttendanceEvent[]> {
  const response = await apiClient.get<AttendanceEvent[]>(
...
export async function createManualAttendanceEvent(
  ...
  const response = await apiClient.post<AttendanceEvent>(
...
export async function updateManualAttendanceEvent(
  ...
  const response = await apiClient.patch<AttendanceEvent>(
...
export async function softDeleteAttendanceEvent(
  eventId: number,
  force = false,
): Promise<{ ok: boolean; id: number }> {
  const response = await apiClient.delete<{ ok: boolean; id: number }>(
...
export async function getNotificationJobs(
  ...
  const response = await apiClient.get<PaginatedResponse<NotificationJob>>(
...
export async function getNotificationDeliveryLogs(
  ...
  const response = await apiClient.get<
    PaginatedResponse<NotificationDeliveryLog>
  >("/api/admin/notifications/delivery-logs", { params });
  return response.data;
}

export async function cancelNotificationJob(
  jobId: number,
...
export async function getAdminPushConfig(): Promise<{
  enabled: boolean;
...
export async function getAdminPushPublicConfig(): Promise<{
  enabled: boolean;
  vapid_public_key: string | null;
}> {
...
export async function getDailyReportArchives(
  ...
  const response = await apiClient.get<
    PaginatedResponse<AdminDailyReportArchive>
...
export async function downloadDailyReportArchive(
  archiveId: number,
): Promise<Blob> {
  const response = await apiClient.get<Blob>(
    `/api/admin/daily-report-archives/${archiveId}/download`,
    {
      responseType: "blob",
    },
  );
...
export async function approveAttendanceExtraCheckinApproval(
  ...
  const response =
    await publicApiClient.post<AttendanceExtraCheckinApprovalApproveResponse>(
...
export async function getEmployeeDeviceOverview(
  ...
  const response = await apiClient.get<EmployeeDeviceOverview[]>(
...
export async function getDashboardEmployeeSnapshot(
  ...
  const response = await apiClient.get<DashboardEmployeeSnapshot>(
...
export async function getControlRoomOverview(
  ...
  const response = await apiClient.get<ControlRoomOverview>(
...
export async function getLeaves(
  ...
  const response = await apiClient.get<LeaveRecord[]>("/api/admin/leaves", {
    params,
  });
  return response.data;
}
...
export async function createDeviceInvite(
  ...
  const response = await apiClient.post<DeviceInviteCreateResponse>(
...
export async function getMonthlyEmployee(
  ...
  const response = await apiClient.get<MonthlyEmployeeResponse>(
...
export async function getDepartmentSummary(
  ...
  const response = await apiClient.get<DepartmentSummaryItem[]>(
...
export async function upsertManualDayOverride(
  ...
  const response = await apiClient.post<ManualDayOverride>(
...
export async function getManualDayOverrides(
  ...
  const response = await apiClient.get<ManualDayOverride[]>(
    "/api/admin/manual-overrides/day",
    {
      params: {
...
export async function deleteManualDayOverride(
  overrideId: number,
): Promise<void> {
...
export async function getComplianceSettings(): Promise<LaborProfile> {
  const response = await apiClient.get<LaborProfile>(
...
export async function updateComplianceSettings(
  ...
  const response = await apiClient.put<LaborProfile>(
    "/api/admin/compliance-settings",
    payload,
  );
  return response.data;
...
export async function downloadPuantajExport(
  params: PuantajExportParams,
): Promise<Blob> {
  const response = await apiClient.get<Blob>(
